-- ============================================================
-- 0012 — Equal problem-statement distribution
-- The pool is small and fixed (e.g. 3 statements x capacity).
-- Pure random() let the distribution drift lopsided early.
-- New rule: always hand out the LEAST-taken statement first,
-- random tie-break only -> 80 teams split ~27/27/26 exactly.
-- ============================================================
