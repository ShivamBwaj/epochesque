  ...
  return (
    <div className="space-y-8">
      <SectionHeading
        kicker="JUDGING"
        title="Scoring"
        description="Enter each team's raw score — Quiz and OC Round out of 10, Senior Final out of 100. The final leaderboard weights them: 10% Round 1 (Quiz) + 20% Round 2 (OC Round) + 70% Senior Final Evaluation. Several people can score different teams at the same time — only edited rows are saved."
      />
